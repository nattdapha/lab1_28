...
class MyAppPage extends StatelessWidget {
  ...
  Widget displayNameItem({required String name, required String imagePath}) {
    bool isHighlight = name == "ณัฐธิดา บุญพา 643450647-2";

    return Container(
      padding: const EdgeInsets.all(10),
      color: isHighlight ? Color.fromARGB(255, 59, 167, 255) : Colors.transparent,
      child: Row(
        children: [
          Image(
            width: 100,
          ...
          Text(
            ...
            style: TextStyle(
              ...
              color: isHighlight ? Color.fromARGB(255, 255, 139, 240) : Colors.black,
            ),
          ),
        ],
      ),
